...
TOOL_CATALOG: list[ToolEntry] = [
    ...
    },
    {
        ...
        "input_summary": "paths; --mode privacy|all|gps|device|personal|time; -r; --json; [--include/--exclude/--min-file-size]",
        "annotations": _ann(read_only=False, destructive=False, idempotent=True),
    },
    {
        "name": "dedup",
    ...
    },
    {
        ...
        "input_summary": "paths; --crop/--aspect/--trim; -r; --json; [--include/--exclude/--min-file-size]",
        "annotations": _ann(read_only=False, destructive=False, idempotent=True),
    },
    {
        "name": "resize",
        ...
        "input_summary": "paths; --size WxH | --percent P | --max-size N; -r; --json; [--include/--exclude/--min-file-size]",
        "annotations": _ann(read_only=False, destructive=False, idempotent=True),
    },
    {
        "name": "rotate",
        ...
        "input_summary": "paths; --degrees 90|180|270; --flip horizontal|vertical; --json; [--include/--exclude/--min-file-size]",
        "annotations": _ann(read_only=False, destructive=False, idempotent=True),
    },
    {
        "name": "watermark",
        ...
        "input_summary": "text|image subcommand; paths; -r; --json; [--include/--exclude/--min-file-size]",
        "annotations": _ann(read_only=False, destructive=False, idempotent=True),
    },
    {
        "name": "montage",
        ...
        "input_summary": "paths; -o output; --cols; --json; [--include/--exclude/--min-file-size]",
        "annotations": _ann(read_only=False, destructive=False, idempotent=True),
    },
    {
        "name": "optimize",
        ...
        "input_summary": "paths; -r; --json; [--include/--exclude/--min-file-size]",
        "annotations": _ann(read_only=True, destructive=False, idempotent=True),
    },
    {
        "name": "info",
    ...
    {
        "name": "video.info",
        "description": "Inspect video container, codecs, duration, and frame properties using the local runtime.",
    ...
    {
        "name": "video.convert",
        "description": "Transcode video to another container/codec using the local runtime.",
    ...
    {
        "name": "video.compress",
        "description": "Reduce video size with CRF presets or fit a byte budget using the local runtime.",
    ...
    {
        "name": "video.concat",
        "description": "Concatenate clips end to end, stream-copy by default, using the local runtime.",
    ...
    {
        "name": "video.trim",
        "description": "Cut a time range; default stream-copy is keyframe-aligned, --reencode is frame-accurate.",
    ...
    },
    {
        ...
        "description": "Extract a still frame as an image using the local runtime.",
    ...
    },
    {
        ...
        "description": "Export the audio track using the local runtime.",
    ...
    {
        "name": "video.gif",
        "description": "Convert a video clip to an animated GIF using the local runtime.",
    ...
    },
    {
        ...
        "input_summary": "paths; -r; --algorithm sha256; --json; [--include/--exclude/--min-file-size]",
        "annotations": _ann(read_only=True, destructive=False, idempotent=True),
    },
]
